          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="relative ml-2" ref={filterRef}>
              <button
                ...
                className="inline-flex items-center px-3 py-2 text-sm font-medium text-zinc-700 dark:text-zinc-300 bg-white dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-600 rounded-md shadow-sm hover:bg-zinc-50 dark:hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition-colors"
              >
            ...
            <div className="relative" ref={sortRef}>
              ...
              >
                ...
                <ChevronDown className={`h-4 w-4 ml-1 transition-transform ${isSortOpen ? "rotate-180" : ""}`} />
              </button>
                ...
                >
                  ...
                  <td className="px-3 sm:px-6 py-4">
                    <div className="flex items-center space-x-1 sm:space-x-2">
                      ...
                      <div>
                        <div className="font-medium text-xs sm:text-sm text-zinc-900 dark:text-white transition-colors">
                          {row.name}
                        </div>
                      </div>
                    </div>
